(function () {
  ...
  require.register("reporters/html.js", function (module, exports, require) {
    ...
    var statsTemplate =
      '<ul id="mocha-stats">' +
      '<li class="passes"><a href="#">패스:</a> <em>0</em></li>' +
      '<li class="failures"><a href="#">미스:</a> <em>0</em></li>' +
    ...
    function HTML(runner, root) {
      ...
      var self = this,
        ...
        passes = items[0].getElementsByTagName("em")[0],
        passesLink = items[0].getElementsByTagName("a")[0],
        failures = items[1].getElementsByTagName("em")[0],
        failuresLink = items[1].getElementsByTagName("a")[0],
        duration = items[2].getElementsByTagName("em")[0],
      ...
      runner.on("test end", function (test) {
        ...
        if (percent === 100 && stats.passes === stats.tests) {
          const winnerEl = document.querySelector(".winner");
          const testCountEl = document.querySelector(".winner .test");

          testCountEl.textContent = stats.passes;
        ...
        if ("passed" == test.state) {
          ...
          var str = test.err.message || test.err.stack || test.err.toString();
