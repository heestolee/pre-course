(function () {
  ...
  require.register(
    "chaijs-assertion-error/index.js",
  ...
  require.register(
    "chaijs-type-detect/lib/type.js",
    function (exports, require, module) {
      /*!
       * type-detect
      ...
      Library.prototype.test = function (obj, type) {
        ...
        if (test && "regexp" === getType(test)) {
          ...
          throw new ReferenceError(
            'Type test "' + type + '" not defined or invalid.'
          );
        }
      };
    }
      ...
      module.exports = function (chai, _) {
        ...
        function assertEqual(val, msg) {
          ...
          if (flag(this, "deep")) {
            ...
            this.assert(
              val === obj,
              "#{exp}을 입력하셨습니다만, 정답이 아닙니다. `result` 변수에 할당되는 값의 연산 결과를 유추하여 입력해주세요. 😎",
              "#{exp}",
              val,
              this._obj,
              true
  ...
  require.alias(
    "chaijs-assertion-error/index.js",
    "chai/deps/assertion-error/index.js"
  );
  require.alias(
    "chaijs-assertion-error/index.js",
    "chai/deps/assertion-error/index.js"
  ...
  require.alias(
    "chaijs-type-detect/lib/type.js",
    "chaijs-deep-eql/deps/type-detect/lib/type.js"
  );
  require.alias(
    "chaijs-type-detect/lib/type.js",
    "chaijs-deep-eql/deps/type-detect/index.js"
  );
  require.alias(
    "chaijs-type-detect/lib/type.js",
    "chaijs-type-detect/index.js"
  );
